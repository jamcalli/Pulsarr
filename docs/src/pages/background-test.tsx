    ...
    <Layout
      ...
      <div style={{ position: 'relative', height: '100vh', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 10, padding: '2rem' }}>
          <h1 style={{ color: 'var(--static-text)', fontSize: '3rem', fontWeight: 'bold', textAlign: 'center' }}>
            Background Test Page
          </h1>
          <p style={{ color: 'var(--static-text)', fontSize: '1.25rem', textAlign: 'center', marginTop: '1rem' }}>
            This page tests the starfield, CRT overlay, planet, and asteroids from the main app.
          </p>
          ...
          <div style={{ 
            ...
            <h2 style={{ color: 'var(--static-text)' }}>Content with Background</h2>
            <p style={{ color: 'var(--text)' }}>This is some content displayed over the animated background.</p>
          </div>
        </div>
      </div>
    </Layout>
