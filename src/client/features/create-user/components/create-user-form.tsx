 ...
 *
 * The form manages validation, displays backend error messages, and updates the submit button's state and label based on submission status. The email input is automatically focused when the form mounts.
 */
