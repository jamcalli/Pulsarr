 ...
 *
 * Sets up form validation with a Zod schema, tracks loading and success states, handles backend and unexpected errors, and focuses the email input on mount. On successful login, displays a welcome toast and redirects the user.
 *
