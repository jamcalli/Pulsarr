...
/**
 * Form component for creating and managing API keys.
 *
 * Provides input for creating new API keys and displays existing keys
 * with options to view, copy, and revoke them.
 */
