...
import { PlexUserEditModal } from '@/features/plex/components/user/plex-user-edit-modal'
import { usePlexUsers } from '@/features/plex/hooks/user/usePlexUsers'
...
export function PlexUserTable() {
  // Use the hooks for user management
  const {
    users,
    isUpdating,
    selectedUser,
  ...
  const columns: ColumnDef<PlexUserType>[] = [
    {
      accessorKey: 'name',
      header: ({ column }) => {
        return (
