...
/**
 * Renders a responsive modal for performing bulk approval, rejection, or deletion of multiple approval requests.
 *
 * The modal adapts between mobile and desktop layouts, manages action permissions based on the statuses of selected requests, and prevents closure during ongoing operations. It provides user feedback for errors and action results, and disables unavailable actions according to the current selection.
 *
 * @returns The modal component for bulk approval, rejection, or deletion actions.
 */
