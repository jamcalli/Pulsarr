 ...
 *
 * @param value - A string containing one or more webhook URLs separated by commas.
 * @returns An array of cleaned webhook URLs, or an empty array if the input is empty or undefined.
 */
