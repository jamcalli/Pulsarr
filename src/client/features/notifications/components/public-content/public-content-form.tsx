...
interface PublicContentFormProps {
  isInitialized: boolean
}

/**
 * Form component for managing public content notifications - broadcast ALL content availability
 * to public Discord channels and shared Apprise endpoints.
 */
export function PublicContentForm({ isInitialized }: PublicContentFormProps) {
  const {
    form,
    isSubmitting,
    isToggling,
  ...
  // Test error states for red tooltips
        ...
        <p>
          {isEnabled
            ? 'Public content notifications are enabled. ALL content ready ' +
              ...
              'configured.'
            : 'Enable this feature to broadcast ALL content availability to public ' +
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="flex items-center gap-4">
            <Button
              ...
              disabled={
                isSubmitting || isToggling || isClearing || !isInitialized
              }
