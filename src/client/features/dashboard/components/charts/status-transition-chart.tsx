 ...
 *
 * Displays a loading indicator while fetching data. The chart features error bars, reference lines for min/max values, and a legend distinguishing movies and shows by color and line style.
 */
