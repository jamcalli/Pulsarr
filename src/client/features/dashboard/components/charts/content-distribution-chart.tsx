 ...
 *
 * Fetches content type distribution data and theme settings, then presents a pie chart with a custom tooltip, legend, and a related breakdown chart to help analyze content composition.
 */
