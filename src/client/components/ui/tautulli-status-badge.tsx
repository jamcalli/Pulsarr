...
/**
 * Displays a badge indicating the current Tautulli service status with color-coded styling.
 *
 * The badge uses green for "running", red for "disabled", and gray for any other status. The status text is capitalized.
 */
