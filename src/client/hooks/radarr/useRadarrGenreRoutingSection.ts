...
export function useRadarrGenreRoutingSection() {
  ...
  const handleSaveNewRoute = useCallback(async (tempId: string, data: GenreRouteFormValues) => {
  ...
  const handleUpdateRoute = useCallback(async (id: number, data: GenreRouteFormValues) => {
