...
export const WebhookPayloadSchema = z.discriminatedUnion('instanceName', [
  ...
  z.object({
    ...
    episodes: z.array(SonarrEpisodeSchema).describe('List of episodes that were processed'),
  }).describe('Sonarr series webhook payload'),
])

export const WebhookResponseSchema = z.object({
  success: z.boolean().describe('Indicates if the webhook was processed successfully'),
})
